...
void Scene3::init(std::vector<Model*> models)
{
	...
	texture = Texture("pbr/wood/oak/albedo.png", TextureType::albedo);
	...
	texture = Texture("pbr/wood/mahog/albedo.png", TextureType::albedo);
	material.addTexture(texture);
	...
	texture = Texture("pbr/uncat/scratched-paint/albedo.png", TextureType::albedo);
	material.addTexture(texture);
	texture = Texture("pbr/uncat/scratched-paint/smoothness.png", TextureType::smoothness);
	material.addTexture(texture);
	texture = Texture("pbr/uncat/scratched-paint/metallic.png", TextureType::metallic);
	material.addTexture(texture);
	texture = Texture("pbr/uncat/scratched-paint/normal.png", TextureType::normal);
	material.addTexture(texture);
	this->spheres_[4]->setMaterial(material);
	material.setDefault();

	texture = Texture("pbr/rock/limestone/albedo.png", TextureType::albedo);
	material.addTexture(texture);
	...
	texture = Texture("pbr/rock/marble-streaked/albedo.png", TextureType::albedo);
	material.addTexture(texture);
	texture = Texture("pbr/rock/marble-streaked/smoothness.png", TextureType::smoothness);
	material.addTexture(texture);
	texture = Texture("pbr/rock/marble-streaked/normal.png", TextureType::normal);
	material.addTexture(texture);
	...
	texture = Texture("pbr/metal/gold-scuffed/albedo.png", TextureType::albedo);
	material.addTexture(texture);
	texture = Texture("pbr/metal/gold-scuffed/smoothness.png", TextureType::smoothness);
	material.addTexture(texture);
	texture = Texture("pbr/metal/gold-scuffed/metallic.png", TextureType::metallic);
	material.addTexture(texture);
	texture = Texture("pbr/metal/gold-scuffed/normal.png", TextureType::normal);
	material.addTexture(texture);
	this->spheres_[9]->setMaterial(material);
	material.setDefault();

	texture = Texture("pbr/metal/aluminum-scuffed/albedo.png", TextureType::albedo);
	material.addTexture(texture);
	texture = Texture("pbr/metal/aluminum-scuffed/smoothness.png", TextureType::smoothness);
	material.addTexture(texture);
	texture = Texture("pbr/metal/aluminum-scuffed/metallic.png", TextureType::metallic);
	material.addTexture(texture);
	texture = Texture("pbr/metal/aluminum-scuffed/normal.png", TextureType::normal);
	material.addTexture(texture);
	this->spheres_[10]->setMaterial(material);
	material.setDefault();	

	texture = Texture("pbr/metal/titanium-scuffed/albedo.png", TextureType::albedo);
	material.addTexture(texture);
	texture = Texture("pbr/metal/titanium-scuffed/smoothness.png", TextureType::smoothness);
	material.addTexture(texture);
	texture = Texture("pbr/metal/titanium-scuffed/metallic.png", TextureType::metallic);
	material.addTexture(texture);
	texture = Texture("pbr/metal/titanium-scuffed/normal.png", TextureType::normal);
	material.addTexture(texture);
	this->spheres_[11]->setMaterial(material);
	material.setDefault();

	texture = Texture("pbr/metal/metal-streaked/albedo.png", TextureType::albedo);
	material.addTexture(texture);
	texture = Texture("pbr/metal/metal-streaked/smoothness.png", TextureType::smoothness);
	material.addTexture(texture);
	texture = Texture("pbr/metal/metal-streaked/metallic.png", TextureType::metallic);
	material.addTexture(texture);
	this->spheres_[12]->setMaterial(material);
	material.setDefault();

	texture = Texture("pbr/metal/iron-scuffed/albedo.png", TextureType::albedo);
	material.addTexture(texture);
	texture = Texture("pbr/metal/iron-scuffed/smoothness.png", TextureType::smoothness);
	material.addTexture(texture);
	texture = Texture("pbr/metal/iron-scuffed/metallic.png", TextureType::metallic);
	material.addTexture(texture);
	texture = Texture("pbr/metal/iron-scuffed/normal.png", TextureType::normal);
	material.addTexture(texture);
	this->spheres_[13]->setMaterial(material);
	material.setDefault();

	texture = Texture("pbr/metal/iron-rusted-streaks/albedo.png", TextureType::albedo);
	material.addTexture(texture);
	texture = Texture("pbr/metal/iron-rusted-streaks/smoothness.png", TextureType::smoothness);
	material.addTexture(texture);
	texture = Texture("pbr/metal/iron-rusted-streaks/metallic.png", TextureType::metallic);
	material.addTexture(texture);
	texture = Texture("pbr/metal/iron-rusted-streaks/normal.png", TextureType::normal);
	material.addTexture(texture);
	this->spheres_[14]->setMaterial(material);
	material.setDefault();

	texture = Texture("pbr/metal/copper-scuffed/albedo.png", TextureType::albedo);
	material.addTexture(texture);
	texture = Texture("pbr/metal/copper-scuffed/smoothness.png", TextureType::smoothness);
	material.addTexture(texture);
	texture = Texture("pbr/metal/copper-scuffed/metallic.png", TextureType::metallic);
	material.addTexture(texture);
	texture = Texture("pbr/metal/copper-scuffed/normal.png", TextureType::normal);
	material.addTexture(texture);
	this->spheres_[15]->setMaterial(material);
	material.setDefault();

	texture = Texture("pbr/metal/copper-oxidized/albedo.png", TextureType::albedo);
	material.addTexture(texture);
	texture = Texture("pbr/metal/copper-oxidized/smoothness.png", TextureType::smoothness);
	material.addTexture(texture);
	texture = Texture("pbr/metal/copper-oxidized/metallic.png", TextureType::metallic);
	material.addTexture(texture);
	texture = Texture("pbr/metal/copper-oxidized/normal.png", TextureType::normal);
	material.addTexture(texture);
	this->spheres_[16]->setMaterial(material);
	material.setDefault();

	texture = Texture("pbr/plastic/plastic-pattern/albedo.png", TextureType::albedo);
	material.addTexture(texture);
	texture = Texture("pbr/plastic/plastic-pattern/smoothness.png", TextureType::smoothness);
	material.addTexture(texture);
	texture = Texture("pbr/plastic/plastic-pattern/normal.png", TextureType::normal);
	material.addTexture(texture);
