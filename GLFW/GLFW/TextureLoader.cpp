...
{
	printf("Searching BMP texture fin %s...", imagepath);
	...
	{
		printf("Wrong BMP texture fin.\n");
		return 0;
	}

	// Проверяем цвета 24бита
...
GLuint loadDDS(const char * imagepath)
{
	...
	printf("Searching DDS texture file %s...", imagepath);

	fin = fopen(imagepath, "rb");
	if (fin == NULL) 
	{
		printf("DDS texture file %s not found.\n", imagepath); 
		return 0;
	}
	else
	{
		printf("DDS texture file found, OK.\n");
	}
