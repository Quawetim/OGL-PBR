...
/* ѕровер€ет близость точек */
bool is_near(float v1, float v2)
{
	return fabs(v1 - v2) < 0.01f;
}

/* ѕоиск одинаковых вершин */
/* ќдинаковые, если одни позиции, одни UV, одни нормали */
